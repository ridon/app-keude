...
import id.ridon.keude.compat.PRNGFixes;
import id.ridon.keude.data.AppProvider;
import id.ridon.keude.data.InstalledAppCacheUpdater;
import id.ridon.keude.data.Repo;
import id.ridon.keude.localrepo.LocalRepoService;
import id.ridon.keude.net.IconDownloader;
...
public class KeudeApp extends Application {
    ...
    private static final String TAG = "id.ridon.keude.KeudeApp";
    ...
    public void onCreate() {
        ...
        Preferences.get().registerLocalRepoHttpsListeners(new ChangeListener() {
            @Override
            public void onPreferenceChange() {
                startService(new Intent(KeudeApp.this, WifiStateChangeService.class));
            }
        });
    }
