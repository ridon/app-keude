...
import id.ridon.keude.compat.Compatibility;
import id.ridon.keude.compat.SupportedArchitectures;
        ...
        if (apk.features != null) {
            for (final String feat : apk.features) {
                if (ignoreTouchscreen
                    ...
                    Log.d("Keude", apk.id + " vercode " + apk.vercode
