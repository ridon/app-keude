...
public class ApkDownloader implements AsyncDownloadWrapper.Listener {
    ...
    private static final String TAG = "id.ridon.keude.net.ApkDownloader";
    ...
    private Hasher createHasher() {
        ...
        try {
            ...
            Log.e("Keude", "Error verifying hash of cached apk at " + localFile + ". " +
    ...
    private boolean verifyOrDeleteCachedVersion() {
        if (localFile.exists()) {
            if (hashMatches()) {
                Log.d("Keude", "Using cached apk at " + localFile);
                return true;
            } else {
                Log.d("Keude", "Not using cached apk at " + localFile);
                deleteLocalFile();
            }
        }
        return false;
    ...
    public void onErrorDownloading(String localisedExceptionDetails) {
        Log.e("Keude", "Download failed: " + localisedExceptionDetails);
    ...
    public void onDownloadComplete() {
        ...
        Log.d("Keude", "Download finished: " + localFile);
        sendCompleteMessage();
    }
