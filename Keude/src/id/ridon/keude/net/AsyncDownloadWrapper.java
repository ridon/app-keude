...
/**
 * Given a {@link id.ridon.keude.net.Downloader}, this wrapper will conduct the download operation on a
...
public class AsyncDownloadWrapper extends Handler {
    ...
    private static final String TAG = "id.ridon.keude.net.AsyncDownloadWrapper";
     ...
     * relevant {@link id.ridon.keude.net.AsyncDownloadWrapper.Listener}
     * @param message
     */
