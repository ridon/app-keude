...
import id.ridon.keude.NfcNotEnabledActivity;
...
public class RepoDetailsFragment extends Fragment {
    ...
    private static final String TAG = "id.ridon.keude.views.fragments.RepoDetailsFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (repo == null) {
            Log.e("Keude", "Error showing details for repo '" + getRepoId() + "'");
