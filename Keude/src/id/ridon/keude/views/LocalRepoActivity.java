...
import id.ridon.keude.localrepo.LocalRepoService;
...
public class LocalRepoActivity extends ActionBarActivity {
    ...
    private static final String TAG = "id.ridon.keude.LocalRepoActivity";
    ...
    public void onResume() {
        super.onResume();
        resetNetworkInfo();
        setRepoSwitchChecked(KeudeApp.isLocalRepoServiceRunning());
        ...
        // if no local repo exists, create one with only Keude in it
        ...
        KeudeApp.startLocalRepoService(LocalRepoActivity.this);
        ...
        stopTimer.schedule(new TimerTask() {
            ...
            @Override
            public void run() {
                KeudeApp.stopLocalRepoService(LocalRepoActivity.this);
            }
        }, 900000); // 15 minutes
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == SET_IP_ADDRESS) {
            ...
            setUIFromWifi();
            new UpdateAsyncTask(this, KeudeApp.selectedApps.toArray(new String[0]))
                    .execute();
        }
    }
    ...
    private void setUIFromWifi() {
        ...
        String buttonLabel = KeudeApp.repo.address.replaceAll("\\?.*$", "");
         ...
         */
        final String qrUriString = Utils.getSharingUri(this, KeudeApp.repo).toString()
        ...
        wifiNetworkNameTextView.setText(KeudeApp.ssid);

        TextView fingerprintTextView = (TextView) findViewById(R.id.fingerprint);
        if (KeudeApp.repo.fingerprint != null) {
            fingerprintTextView.setVisibility(View.VISIBLE);
            fingerprintTextView.setText(KeudeApp.repo.fingerprint);
        } else {
        ...
        if (Build.VERSION.SDK_INT >= 14) {
            ...
            nfcAdapter.setNdefPushMessage(new NdefMessage(new NdefRecord[] {
                    NdefRecord.createUri(Utils.getSharingUri(this, KeudeApp.repo)),
            }), this);
        }
    }
