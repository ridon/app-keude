...
public final class Utils {
    ...
    public static Uri getSharingUri(Context context, Repo repo) {
        ...
        if (!TextUtils.isEmpty(KeudeApp.bssid)) {
            b.appendQueryParameter("bssid", Uri.encode(KeudeApp.bssid));
            if (!TextUtils.isEmpty(KeudeApp.ssid))
                b.appendQueryParameter("ssid", Uri.encode(KeudeApp.ssid));
        }
        return b.build();
    }
    ...
    public static String calcFingerprint(String keyHexString) {
        if (TextUtils.isEmpty(keyHexString)
            ...
            Log.e("Keude", "Signing key certificate was blank or contained a non-hex-digit!");
            return null;
        } else
    ...
    public static String calcFingerprint(byte[] key) {
        String ret = null;
        if (key.length < 256) {
            Log.e("Keude", "key was shorter than 256 bytes (" + key.length + "), cannot be valid!");
            return null;
        }
        try {
            ...
            Log.w("Keude", "Unable to get certificate fingerprint.\n"
    ...
    public static String hashBytes(byte[] input, String algo) {
        try {
            ...
            Log.e("Keude", "Device does not support " + algo + " MessageDisgest algorithm");
            return null;
        }
    }
    ...
    public static String getBinaryHash(File apk, String algo) {
        ...
        try {
            ...
            Log.e("Keude", "Error reading \"" + apk.getAbsolutePath()
