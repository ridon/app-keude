...
package id.ridon.keude.localrepo;
...
import id.ridon.keude.Preferences.ChangeListener;
import id.ridon.keude.R;
import id.ridon.keude.Utils;
import id.ridon.keude.net.LocalHTTPD;
import id.ridon.keude.net.WifiStateChangeService;
import id.ridon.keude.views.swap.SwapActivity;
...
public class LocalRepoService extends Service {
    ...
    public static final String STATE = "id.ridon.keude.action.LOCAL_REPO_STATE";
    public static final String STARTED = "id.ridon.keude.category.LOCAL_REPO_STARTED";
    public static final String STOPPED = "id.ridon.keude.category.LOCAL_REPO_STOPPED";
        ...
        Runnable webServer = new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    int prev = KeudeApp.port;
                    KeudeApp.port = KeudeApp.port + new Random().nextInt(1111);
                    Log.w(TAG, "port " + prev + " occupied, trying on " + KeudeApp.port + "!");
    ...
    private void registerMDNSService() {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                values.put("fingerprint", KeudeApp.repo.fingerprint);
                String type;
                ...
                try {
                    pairService = ServiceInfo.create(type, repoName, KeudeApp.port, 0, 0, values);
                    jmdns = JmDNS.create();
