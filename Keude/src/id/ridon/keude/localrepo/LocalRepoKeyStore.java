...
public class LocalRepoKeyStore {
    ...
    private static final String TAG = "id.ridon.keude.localrepo.LocalRepoKeyStore";
    ...
    public void setupHTTPSCertificate() {
        try {
             ...
             */
            X500Name subject = new X500Name("CN=" + KeudeApp.ipAddressString);
            Certificate indexCert = generateSelfSignedCertChain(kerplappKeypair, subject,
                    KeudeApp.ipAddressString);
