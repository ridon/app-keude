...
public class RepoProvider extends KeudeProvider {
    ...
    public static final class Helper {
        ...
        public static void update(Context context, Repo repo,
             ...
             * when a repo URI is received by Keude to prevent bad actors from
        ...
        public static void purgeApps(Context context, Repo repo, KeudeApp app) {
            Uri apkUri = ApkProvider.getRepoUri(repo.getId());
            ContentResolver resolver = context.getContentResolver();
            int apkCount = resolver.delete(apkUri, null, null);
            Log.d("Keude", "Removed " + apkCount + " apks from repo " + repo.name);
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (matcher.match(uri)) {
            ...
            default:
                Log.e("Keude", "Invalid URI for repo content provider: " + uri);
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        Log.i("Keude", "Inserted repo. Notifying provider change: '" + uri + "'.");
    ...
    public int delete(Uri uri, String where, String[] whereArgs) {
        ...
        Log.i("Keude", "Deleted repos. Notifying provider change: '" + uri + "'.");
        getContext().getContentResolver().notifyChange(uri, null);
        return rowsAffected;
    }
    ...
    public int update(Uri uri, ContentValues values, String where, String[] whereArgs) {
        ...
        Log.i("Keude", "Updated repo. Notifying provider change: '" + uri + "'.");
        getContext().getContentResolver().notifyChange(uri, null);
        return numRows;
    }
