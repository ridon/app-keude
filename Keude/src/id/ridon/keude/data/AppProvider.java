...
public class AppProvider extends KeudeProvider {
     ...
     * {@link id.ridon.keude.data.QuerySelection#add(QuerySelection)} and
     * {@link id.ridon.keude.data.QuerySelection#add(String, String[])} methods
     * will only return the base class {@link id.ridon.keude.data.QuerySelection}
     * which is not aware of the installed app table.
     * However, the
     * {@link id.ridon.keude.data.AppProvider.AppQuerySelection#add(id.ridon.keude.data.AppProvider.AppQuerySelection)}
    ...
    public Cursor query(Uri uri, String[] projection, String customSelection, String[] selectionArgs, String sortOrder) {
        ...
        switch (matcher.match(uri)) {
            ...
            default:
                Log.e("Keude", "Invalid URI for app content provider: " + uri);
    ...
    private void updateSuggestedFromUpstream() {
        ...
        Log.d("Keude", "Calculating suggested versions for all apps which specify an upstream version code.");
    ...
    private void updateCompatibleFlags() {
        ...
        Log.d("Keude", "Calculating whether apps are compatible, based on whether any of their apks are compatible");
    ...
    private void updateSuggestedFromLatest() {
        ...
        Log.d("Keude", "Calculating suggested versions for all apps which don't specify an upstream version code.");
    ...
    private void updateIconUrls() {
        ...
        Log.d("Keude", "Updating icon paths for apps belonging to repos with version >= " + Repo.VERSION_DENSITY_SPECIFIC_ICONS);
        String iconsDir = Utils.getIconsDir(getContext());
        Log.d("Keude", "Using icon dir '"+iconsDir+"'");
