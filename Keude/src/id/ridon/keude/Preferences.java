...
/**
 * Handles shared preferences for Keude, looking after the names of
 * preferences, default values and caching. Needs to be setup in the KeudeApp
 * (using {@link Preferences#setup(android.content.Context)} before it gets
 * accessed via the {@link id.ridon.keude.Preferences#get()}
 * singleton method.
 */
public class Preferences implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        Log.d("Keude", "Invalidating preference '" + key + "'.");
        uninitialize(key);
    ...
    public static void setup(Context context) {
        if (instance != null) {
            String error = "Attempted to reinitialize preferences after it " +
                    "has already been initialized in KeudeApp";
            Log.e("Keude", error);
    ...
    public static Preferences get() {
        if (instance == null) {
            String error = "Attempted to access preferences before it " +
                    "has been initialized in KeudeApp";
            Log.e("Keude", error);
            throw new RuntimeException(error);
        }
        return instance;
